...
ADDONS_DIR="/data/$OE_USER/custom"
OE_CONFIG="${OE_USER}"
...
cd $ADDONS_DIR/it-projects-llc/misc-addons
pip install -r requirements.txt

cd $ADDONS_DIR/it-projects-llc/odoo-saas-tools
pip install -r requirements.txt

cd $ADDONS_DIR/it-projects-llc/odoo-telegram
pip install -r requirements.txt
